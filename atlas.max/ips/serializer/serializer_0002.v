...
module  serializer_0002_ddio_out_vbd
	( 
	datain_h,
	datain_l,
	dataout,
...
endmodule //serializer_0002_ddio_out_vbd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  serializer_0002_cmpr_jqb
	( 
	aeb,
	dataa,
...
endmodule //serializer_0002_cmpr_jqb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  serializer_0002_cmpr_qge
	( 
	aeb,
	dataa,
	datab) /* synthesis synthesis_clearbox=1 */;
...
`endif
	...
	assign
		...
		data_wire = {datab[2], dataa[2], datab[1], dataa[1], datab[0], dataa[0], (data_wire[6] ^ data_wire[7]), ((data_wire[2] ^ data_wire[3]) | (data_wire[4] ^ data_wire[5]))},
		eq_wire = aeb_result_wire;
endmodule //serializer_0002_cmpr_qge

//synthesis_resources = lut 3 reg 3 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  serializer_0002_cntr_a5d
	( 
	clock,
	q,
...
`endif
	...
	serializer_0002_cmpr_qge   cmpr18
	( 
	.aeb(wire_cmpr18_aeb),
	.dataa(safe_q),
	.datab(modulus_bus));
	assign
		...
		updown_dir = updown;
endmodule //serializer_0002_cntr_a5d
...
//VERSION_BEGIN 17.1 cbx_lpm_shiftreg 2017:10:25:18:06:53:SJ cbx_mgl 2017:10:25:18:08:29:SJ  VERSION_END

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  serializer_0002_shift_reg_bod
	( 
	clock,
	data,
	load,
...
endmodule //serializer_0002_shift_reg_bod

//synthesis_resources = IO 3 lut 3 reg 53 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  serializer_0002
	( 
	tx_coreclock,
	tx_in,
	tx_inclock,
...
`endif
	...
	serializer_0002_ddio_out_vbd   ddio_out
	( 
	.datain_h(l_input),
	.datain_l(h_input),
	...
	serializer_0002_cmpr_jqb   cmpr10
	( 
	.aeb(wire_cmpr10_aeb),
	.dataa(dffe4a),
	.datab(dffe8a));
	serializer_0002_cmpr_jqb   cmpr9
	( 
	.aeb(wire_cmpr9_aeb),
	.dataa(dffe3a),
	.datab(dffe7a));
	serializer_0002_cntr_a5d   cntr2
	( 
	.clock(fast_clock),
	.q(wire_cntr2_q),
	.updown(sync_dffe1a));
	serializer_0002_shift_reg_bod   shift_reg12
	( 
	.clock(fast_clock),
	...
	serializer_0002_shift_reg_bod   shift_reg13
	( 
	.clock(fast_clock),
	...
	serializer_0002_shift_reg_bod   shift_reg14
	( 
	.clock(fast_clock),
	...
	serializer_0002_shift_reg_bod   shift_reg15
	( 
	.clock(fast_clock),
	...
	serializer_0002_shift_reg_bod   shift_reg16
	( 
	.clock(fast_clock),
	...
	serializer_0002_shift_reg_bod   shift_reg17
	( 
	.clock(fast_clock),
